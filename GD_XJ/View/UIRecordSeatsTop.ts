...
@ccclass
export default class UIRecordSeatsTop extends UIRecordSeatsBase
{
    ...
    public LayoutHandCards()
    {
        ...
        {
            Weight = -( this.HandCardGrpList.GetCount() * this.CardLayout.CardWeight - LayoutWeight) / ( this.HandCardGrpList.GetCount() - Count );     
        }
